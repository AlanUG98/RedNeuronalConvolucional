...
data_directory = r'C:\Users\xatla\Desktop\TTv2\datasetFInal'
...
y_train_one_hot = to_categorical(y_train, num_classes=3)  # 3 es el número de clases
...
model.add(layers.Dense(3, activation='softmax'))  # 3 clases para los 3 gestos
...
model.save(r'C:\Users\xatla\Desktop\TTv2\codigosPython\redNeuronalEntrenada\modelo_gestos.h5')